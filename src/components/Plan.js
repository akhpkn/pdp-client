        ...
        <div style={{
            ...
            <div style={{display: "flex", marginTop: "5px", alignItems: "baseline"}}>
                <Typography.Title level={3} style={{
                    ...
                    textAlign: "left",
                    maxWidth: "600px"
                }}>{props.plan.title}</Typography.Title>
                <Space style={{marginLeft: "auto", marginRight: "10px"}}>
                    <Tooltip title="Раскрыть">
                        <Button icon={<ExpandAltOutlined/>} onClick={openPlan}/>
                    </Tooltip>
                    {props.owned &&
            ...
            {props.plan.userEmail
                ? <Typography.Paragraph style={{
                    ...
                    fontSize: 16,
                    textAlign: "left"
                }}>Автор: {props.plan.userName} {props.plan.userSurname}</Typography.Paragraph>
                : null
            }
            <Typography.Paragraph style={{
                marginLeft: "10px",
                fontSize: 16,
                textAlign: "left"
            }}>{`Дата создания: ${TimeUtil.toDate(props.plan.createDt)}`}</Typography.Paragraph>
            <Typography.Paragraph style={{
                marginLeft: "10px",
                fontSize: 16,
                textAlign: "left"
